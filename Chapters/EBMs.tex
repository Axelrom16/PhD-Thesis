...
Energy-Based Models (EBMs) \cite{LeCun2006ATO} are a general class of models that capture dependencies by associating 
...
families of approximations: contrastive methods (such as Markov Chain Monte Carlo or Contrastive Divergence [Hinton, 2002]), 
which approximate the model expectation, and non-contrastive/regularized methods (such as Score Matching [Hyvärinen, 2005] or 
